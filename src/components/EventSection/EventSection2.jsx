...
const EventSection2 = () => {
  ...
  return (
    <div id="events-section-container" className="relative py-8">
      ...
      <div className="event-section__actions flex items-center gap-2">
        ...
        <div className="event-section__slide-num flex items-center text-[#D496EB] text-2xl font-goord gap-4">
          ...
          <p className="text-sm opacity-90">-</p>
          <p>01</p>
          <p className="text-sm opacity-90">02</p>
          <p className="text-sm opacity-90">03</p>
        </div>
